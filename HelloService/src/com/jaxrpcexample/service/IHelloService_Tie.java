...
public class IHelloService_Tie
    ...
    public IHelloService_Tie() throws Exception {
        super(new com.jaxrpcexample.proxy.Hello_SerializerRegistry().getRegistry());
    ...
    private void invoke_sayHello(StreamingHandlerState state) throws Exception {
        ...
        com.jaxrpcexample.service.IHelloService_sayHello_RequestStruct myIHelloService_sayHello_RequestStruct = null;
        ...
        if (myIHelloService_sayHello_RequestStructObj instanceof SOAPDeserializationState) {
            myIHelloService_sayHello_RequestStruct = (com.jaxrpcexample.service.IHelloService_sayHello_RequestStruct)((SOAPDeserializationState)myIHelloService_sayHello_RequestStructObj).getInstance();
        } else {
            myIHelloService_sayHello_RequestStruct = (com.jaxrpcexample.service.IHelloService_sayHello_RequestStruct)myIHelloService_sayHello_RequestStructObj;
        }
        
        try {
            java.lang.String result = 
                ((com.jaxrpcexample.service.IHelloService) getTarget()).sayHello(myIHelloService_sayHello_RequestStruct.getString_1());
            com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct myIHelloService_sayHello_ResponseStruct =
                new com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct();
            ...
            case sayHello_OPCODE:
                {
                    ...
                    theMethod = (com.jaxrpcexample.service.IHelloService.class).getMethod("sayHello", carray);
                }
                break;
    ...
    private void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myIHelloService_sayHello_RequestStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.jaxrpcexample.service.IHelloService_sayHello_RequestStruct.class, ns2_sayHello_TYPE_QNAME);
        ns2_myIHelloService_sayHello_ResponseStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct.class, ns2_sayHelloResponse_TYPE_QNAME);
    }
    
    private static final javax.xml.namespace.QName portName = new QName("http://service.jaxrpcexample.com/wsdl", "IHelloService");
    ...
    private static final javax.xml.namespace.QName ns2_sayHello_TYPE_QNAME = new QName("http://service.jaxrpcexample.com/types", "sayHello");
    ...
    private static final javax.xml.namespace.QName ns2_sayHelloResponse_TYPE_QNAME = new QName("http://service.jaxrpcexample.com/types", "sayHelloResponse");
    private CombinedSerializer ns2_myIHelloService_sayHello_ResponseStruct_SOAPSerializer;
    private static final java.lang.String[] myNamespace_declarations =
                                        new java.lang.String[] {
                                            "ns0", "http://service.jaxrpcexample.com/types"
                                        };
