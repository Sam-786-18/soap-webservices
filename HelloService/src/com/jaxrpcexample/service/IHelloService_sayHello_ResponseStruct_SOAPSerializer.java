...
public class IHelloService_sayHello_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct instance = new com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct();
        com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct instance = (com.jaxrpcexample.service.IHelloService_sayHello_ResponseStruct)obj;
