...
public class BookServiceImplServiceLocator extends org.apache.axis.client.Service implements com.nareshit.service.BookServiceImplService {
    ...
    private java.lang.String BookServiceImpl_address = "http://localhost:2525/AxisProject/services/BookServiceImpl";
    ...
    public com.nareshit.service.BookServiceImpl getBookServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.nareshit.service.BookServiceImplSoapBindingStub _stub = new com.nareshit.service.BookServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.nareshit.service.BookServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.nareshit.service.BookServiceImplSoapBindingStub _stub = new com.nareshit.service.BookServiceImplSoapBindingStub(new java.net.URL(BookServiceImpl_address), this);
                _stub.setPortName(getBookServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.nareshit.com", "BookServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.nareshit.com", "BookServiceImpl"));
        }
