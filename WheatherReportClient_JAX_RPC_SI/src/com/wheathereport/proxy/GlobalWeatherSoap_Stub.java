...
package com.wheathereport.proxy;
...
public class GlobalWeatherSoap_Stub
    ...
    implements com.wheathereport.proxy.GlobalWeatherSoap {
    ...
    public GlobalWeatherSoap_Stub(HandlerChain handlerChain) {
        super(handlerChain);
        _setProperty(ENDPOINT_ADDRESS_PROPERTY, "http://www.webservicex.com/globalweather.asmx");
    }
    ...
    public java.lang.String getWeather(java.lang.String cityName, java.lang.String countryName)
        ...
        try {
            ...
            com.wheathereport.proxy.GetWeather _myGetWeather = new com.wheathereport.proxy.GetWeather();
            ...
            com.wheathereport.proxy.GetWeatherResponse _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (com.wheathereport.proxy.GetWeatherResponse)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (com.wheathereport.proxy.GetWeatherResponse)_responseObj;
            }
    ...
    public java.lang.String getCitiesByCountry(java.lang.String countryName)
        ...
        try {
            ...
            com.wheathereport.proxy.GetCitiesByCountry _myGetCitiesByCountry = new com.wheathereport.proxy.GetCitiesByCountry();
            ...
            com.wheathereport.proxy.GetCitiesByCountryResponse _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (com.wheathereport.proxy.GetCitiesByCountryResponse)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (com.wheathereport.proxy.GetCitiesByCountryResponse)_responseObj;
            }
    ...
    public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_myGetWeatherResponse_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.wheathereport.proxy.GetWeatherResponse.class, ns1_GetWeatherResponse_TYPE_QNAME);
        ns1_myGetWeather_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.wheathereport.proxy.GetWeather.class, ns1_GetWeather_TYPE_QNAME);
        ns1_myGetCitiesByCountry_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.wheathereport.proxy.GetCitiesByCountry.class, ns1_GetCitiesByCountry_TYPE_QNAME);
        ns1_myGetCitiesByCountryResponse_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.wheathereport.proxy.GetCitiesByCountryResponse.class, ns1_GetCitiesByCountryResponse_TYPE_QNAME);
    }
